...
//#region node_modules/.nitro/vite/services/ssr/server.js
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CelkanKx.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BXA6GLqM.mjs"),
		import("./start-Dx6gLAVz.mjs"),
