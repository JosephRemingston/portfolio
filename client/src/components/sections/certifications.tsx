...
const certifications = [
  {
    ...
    url: "https://www.udemy.com/certificate/UC-7f0a833d-db7d-427d-93ce-c045cec15025/"
  },
  {
    ...
    url: "https://www.coursera.org/account/accomplishments/specialization/WSESEH82STCH"
  }
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <Button
                  variant="default"
                  onClick={() => window.location.href = cert.url}
                >
                  View Certification
                </Button>
              </CardContent>
